...
const CSS_STYLES = `
            ...
            /*====================================================================================================================================*/
                    ...
                    .bbgl-prefs-tab-title:first-child { margin-top:0; } .torn-btn { /*----------------------------------------------------*/
                    ...
                    text-transform:uppercase; box-sizing:border-box; display:block; transition:none; } .torn-btn:hover { /*---------------*/
                    background-image:linear-gradient(rgb(51,51,51) 0%,rgb(119,119,119) 25%,rgb(51,51,51) 59%,rgb(102,102,102) 78%,rgb(51,51,51) 100%);
                    color:#fff; } .torn-btn:active { background-image:linear-gradient(#000 0%,#333 100%); color:#ddd; /*------------------*/
                    box-shadow:rgba(255,255,255,.07) 0 -1px 0 0 inset; border-color:#ddd; } .torn-btn-green { /*-----------------------*/
                    background-image:linear-gradient(#0e1806 0%,#3e5e22 25%,#2b4216 60%,#2b4216 78%,#0e1806 100%)!important; /*-----------*/
                    border-color:#0e1806!important; } .torn-btn-green:hover { /*----------------------------------------------------------*/
                    ...
                    border-color:#555!important; } .torn-btn-purple { /*------------------------------------------------------------------*/
                    background-image:linear-gradient(#1a0529 0%,#6a1b9a 25%,#4a1070 60%,#4a1070 78%,#1a0529 100%)!important; /*-----------*/
                    border-color:#1a0529!important; } .torn-btn-purple:hover { /*---------------------------------------------------------*/
                    ...
                    border-color:#555!important; } .bbgl-settings-body { background-color:#333; border:1px solid #111; border-top:none;
                    border-radius:0 0 5px 5px; padding:4px 0; margin-bottom:5px; display:flex; flex-direction:column; /*------------------*/
                    ...
                    width:100%; background:#333; border:1px solid #555; color:#fff; padding:8px 30px; font-family:'Roboto Mono',monospace;
                    font-size:12px; border-radius:4px; box-sizing:border-box; } .bbgl-paste-icon { position:absolute; left:4px; top:50%;
                    transform:translateY(-50%); cursor:pointer; width:22px; height:22px; display:flex; align-items:center; /*-------------*/
                    justify-content:center; user-select:none; z-index:15; } .bbgl-paste-icon svg { fill:#888; transition:fill .2s; /*-----*/
                    width:14px; height:14px; } .bbgl-paste-icon:hover svg { fill:#fff; } .bbgl-expanded .bbgl-paste-icon { width:26px; /*-*/
                    height:26px; } .bbgl-expanded .bbgl-paste-icon svg { width:17px; height:17px; } .bbgl-native-select { background:#333;
                    color:#fff; border:1px solid #555; padding:4px 8px; border-radius:4px; font-size:12px; cursor:pointer; } .bbgl-switch {
                    position:relative; display:inline-block; width:34px; height:18px; } .bbgl-switch input { opacity:0; width:0; height:0;
                    ...
                    .bbgl-bestgym-logo { width:16px; height:16px; flex-shrink:0; } .bbgl-bestgym-label { white-space:nowrap; position:relative; top:1px; } /*-------------------------------------------------*/
                    ...
                    .bbgl-btn-grid .torn-btn { flex:1; } .bbgl-btn-grid .torn-btn:first-of-type { border-top-right-radius:0; /*-----------*/
                    border-bottom-right-radius:0; border-bottom-left-radius:0; border-right:none; } .bbgl-btn-grid .torn-btn:last-of-type {
                    border-top-left-radius:0; border-bottom-left-radius:0; border-bottom-right-radius:0; } /*-----------------------------*/
                    .bbgl-settings-body .bbgl-api-grid { display:flex!important; flex-direction:row!important; gap:0!important; /*--------*/
                    margin:0 10px 10px!important; width:auto!important; } .bbgl-api-grid .torn-btn { flex:1 1 0!important; /*-------------*/
                    margin:0!important; width:50%!important; } .bbgl-api-grid .torn-btn:first-child { border-top-right-radius:0!important;
                    border-bottom-right-radius:0!important; border-top-left-radius:5px!important; border-bottom-left-radius:5px!important;
                    border-right:none!important; } .bbgl-api-grid .torn-btn:last-child { border-top-left-radius:0!important; /*-----------*/
                    border-bottom-left-radius:0!important; border-top-right-radius:5px!important; border-bottom-right-radius:5px!important;
                    } .close-settings-btn { position:absolute; background:transparent; border:none; color:rgba(80,200,120,.7); /*---------*/
                    cursor:pointer; z-index:200; transition:all .2s; user-select:none; top:12px; right:12px; width:22px; height:22px; /*--*/
                    display:flex; align-items:center; justify-content:center; padding:0; } .close-settings-btn svg { width:100%; /*-------*/
                    height:100%; filter:drop-shadow(0 2px 3px rgba(0,0,0,.5)); transition:all .2s; } .close-settings-btn:hover { /*------*/
                    color:#69f0ae; transform:scale(1.1); filter:drop-shadow(0 0 6px rgba(105,240,174,.4)); } .bbgl-close-x { /*-----------*/
                    color:rgba(220,80,80,.7)!important; } .bbgl-close-x:hover { color:#ff6b6b!important; /*-------------------------------*/
                    filter:drop-shadow(0 0 6px rgba(255,100,100,.4))!important; } .bbgl-close-purple { color:rgba(171,71,188,.7)!important;
                    } .bbgl-close-purple:hover { color:#ce93d8!important; filter:drop-shadow(0 0 6px rgba(171,71,188,.4))!important; } /*-*/
                    .bbgl-expanded .close-settings-btn { top:12px; right:16px; width:25px; height:25px; } /*------------------------------*/
                    .bbgl-settings-body .bbgl-api-container { margin:8px 10px; width:auto; } .bbgl-settings-body #updt-settings-btn { /*--*/
                    ...
                    fill:#fff; stroke:#fff; } .bbgl-sb-notif [class*="desktopLink___"] { /*-----------------------------------------------*/
                    ...
                    background:linear-gradient(90deg,transparent 0%,rgba(255,255,255,.3) 50%,transparent 100%); } .bbgl-native-title { /**/
                    font-family:Arial; font-weight:700; font-size:22px; color:#999; text-transform:capitalize; letter-spacing:.1px; /*----*/
                    display:flex; align-items:center; gap:10px; margin-left:-7px; padding-left:0; } .bbgl-native-links { display:flex; /*-*/
                    gap:15px; font-size:18px; color:#999; font-weight:700; } .bbgl-native-link { display:flex; align-items:center; gap:5px;
                    cursor:pointer; transition:color .2s; } .bbgl-native-link:hover { color:#ccc; } .bbgl-native-link svg { width:20px; /**/
                    height:20px; fill:currentColor; } body.bbgl-page-mode-active #bbgl-page-container .bbgl-native-title { /*-------------*/
                    ...
                    --bbgl-gx:clamp(7px,1.78cqi,12px); --bbgl-label-case:uppercase; --bbgl-viewer-title-top-shift:3px; /*-----------------*/
                    container-type:inline-size; container-name:bbgl-panel; position:fixed; bottom:${LAYOUT.LIFT_HEIGHT}px; right:10px; z-index:999989;
                    font-family:Arial,sans-serif; display:none; flex-direction:column; background:#2a2a2a; border:1px solid #444; /*------*/
                    border-radius:5px; box-shadow:0 -2px 4px rgba(0,0,0,.35); width:300px; height:438.5px; /*----------------------------*/
                    ...
                    --bbgl-f-label:clamp(12.5px,2.34cqi,13.5px); --bbgl-f-top:clamp(12.5px,2.34cqi,13.5px); /*----------------------------*/
                    --bbgl-f-bot:clamp(10.5px,1.997cqi,11.5px); --bbgl-f-top-mb:3px; --bbgl-bot-minh:14px; /*-----------------------------*/
                    --bbgl-col-gap:clamp(8px,2.78cqi,16px); --bbgl-label-case:none; width:min(576px, calc(100vw - 20px)); height:633px; /**/
                    max-height:calc(100vh - 50px)!important; overflow-y:auto; overflow-x:hidden; } #bbgl-panel.bbgl-tall { /*-------------*/
                    --bbgl-f-label:12px; --bbgl-f-top:12px; --bbgl-f-bot:11px; --bbgl-col-gap:13px; } #bbgl-panel.bbgl-tall.bbgl-expanded {
                    --bbgl-f-label:clamp(13.75px,calc(2px + 2.34cqi),15.5px); --bbgl-f-top:clamp(13.75px,calc(2px + 2.34cqi),15.5px); /*--*/
                    --bbgl-f-bot:clamp(11.75px,calc(1.5px + 1.997cqi),13px); --bbgl-col-gap:clamp(22px,calc(35.5px - 2.34cqi),24.5px); }
                    #bbgl-panel.bbgl-mode-page { position:relative!important; top:0!important; left:0!important; right:auto!important; /*-*/
                    bottom:auto!important; width:100%!important; flex:none!important; max-width:none!important; height:auto!important; /*-*/
                    max-height:none!important; border:1px solid #444!important; border-radius:5px!important; /*---------------------------*/
                    box-shadow:0 10px 30px rgba(0,0,0,.5)!important; box-sizing:border-box!important; background:#2a2a2a!important; /*---*/
                    display:flex!important; flex-direction:column!important; gap:0!important; z-index:1!important; /*---------------------*/
                    overflow-x:hidden!important; overflow-y:visible!important; } #bbgl-panel.bbgl-mode-page { /*--------------------------*/
                    --bbgl-label-case:none!important; --bbgl-page-t:clamp(0,calc((100cqi - 350px) / 370px),1); /*-------------------------*/
                    ...
                    --bbgl-col-gap:clamp(6px,calc(6px + 20px * var(--bbgl-page-t)),26px); } .bbgl-mode-page .bbgl-header { /*-------------*/
                    ...
                    height:clamp(180px,calc(180px + 90px * var(--bbgl-page-t)),270px)!important; width:100%; margin-bottom:0!important; /**/
                    border:none!important; border-bottom:1px solid #444!important; border-radius:0!important; display:flex; /*------------*/
                    flex-direction:column; padding-top:clamp(2px,calc(2px + 18px * var(--bbgl-page-t)),20px)!important; /*----------------*/
                    overflow:hidden!important; box-shadow:inset 0 0 40px rgba(0,0,0,.95)!important; } /*---------------------------------*/
                    #bbgl-panel.bbgl-mode-page .bbgl-header-wrapper { flex:0 0 clamp(108px,calc(108px + 89px * var(--bbgl-page-t)),197px);
                    } #bbgl-panel.bbgl-mode-page .bbgl-header-wrapper::before { left:4px; right:4px; } /*---------------------------------*/
                    #bbgl-panel.bbgl-mode-page .bbgl-month-header { padding-left:clamp(4px,calc(4px + 3px * var(--bbgl-page-t)),7px); /*--*/
                    padding-right:clamp(16px,calc(16px + 16px * var(--bbgl-page-t)),32px); /*---------------------------------------------*/
                    gap:clamp(8px,calc(8px + 8px * var(--bbgl-page-t)),16px); padding-bottom:6px; } @container bbgl-panel (max-width:499px) { /*--------------*/
                    #bbgl-panel.bbgl-mode-page { --bbgl-label-case:none!important; } } .bbgl-mode-page #bbgl-bottom-panel { /*------------*/
                    flex:none!important; width:100%; border:none!important; border-radius:0!important; background:0 0!important; /*-------*/
                    min-height:0; display:flex; flex-direction:column; height:auto!important; overflow:visible!important; } /*------------*/
                    .bbgl-mode-page #bbgl-settings-view { flex:none; height:auto!important; } .bbgl-mode-page .bbgl-settings-scroll-area {
                    overflow-y:visible!important; height:auto!important; flex:none; } /*--------------------------------------------------*/
                    ...
                    #bbgl-panel.bbgl-mode-page .bbgl-grid-container { height:auto!important; flex:none!important; /*----------------------*/
                    ...
                    overflow:hidden!important; } .bbgl-mode-page .bbgl-cal-container { height:auto!important; display:flex; /*------------*/
                    flex-direction:column; } .bbgl-mode-page .bbgl-row-slice { flex:none!important; width:100%; } /*----------------------*/
                    .bbgl-mode-page .bbgl-day-cell { aspect-ratio:1/1!important; height:auto!important; width:100%!important; } /*--------*/
                    #bbgl-panel.bbgl-mode-page .ledger-content:not(#bbgl-achievements-container) { height:auto!important; /*--------------*/
                    ...
                    padding-bottom:clamp(0px,calc(0px + 15px * var(--bbgl-page-t)),15px)!important; padding-left:4px!important; /*--------*/
                    ...
                    --bbgl-ach-footer-pt:clamp(0px,calc(1px + 1px * var(--bbgl-page-t)),2px); --bbgl-ach-footer-pb:0; /*----------------*/
                    ...
                    justify-content:center!important; margin:0 -1px 0 -.4px!important; padding:0!important; cursor:pointer!important; /*--*/
                    position:relative!important; z-index:-10!important; transform:none!important; pointer-events:auto!important; } /*-----*/
                    #bbgl-gym-tab svg { margin:0!important; display:block; transition:filter .2s ease; /*---------------------------------*/
                    filter:drop-shadow(rgba(0,0,0,.8) 0 0 2px); } #bbgl-gym-tab:hover { /*-----------------------------------------------*/
                    ...
                    font-weight:700; text-transform:Title Case; padding:0 8px; border-bottom:1px solid #000; border-radius:5px 5px 0 0; /**/
                    box-shadow:rgba(255,255,255,.25) 0 0 4px 0 inset,rgba(0,0,0,.5) 0 -2px 4px 0; width:100%; height:38px; display:flex;
                    align-items:center; justify-content:space-between; box-sizing:border-box; cursor:pointer; position:relative; /*-------*/
                    z-index:50; user-select:none; } .bbgl-header:hover { background-image:linear-gradient(#0099cc,#004d66); } /*----------*/
                    #bbgl-header-icon { transition:filter .2s; filter:drop-shadow(rgba(0,0,0,.25) 0 0 2px); } /*-------------------------*/
                    .bbgl-header:hover #bbgl-header-icon { filter:brightness(1.1) drop-shadow(rgba(0,0,0,.25) 0 0 2px); } /*-------------*/
                    .bbgl-header-left { display:flex; align-items:center; pointer-events:none; } .bbgl-header-text { margin-left:2px; /*--*/
                    font-weight:700; } .bbgl-short-title { display: inline; } .bbgl-long-title { display: none; } /*----------------------*/
                    .bbgl-expanded .bbgl-short-title { display: none; } .bbgl-expanded .bbgl-long-title { display: inline; } /*-----------*/
                    .bbgl-header-right { display:flex; align-items:center; } .bbgl-custom-icon { font-size:22px; color:#c0c0c0; /*--------*/
                    cursor:pointer; margin:0 6px; font-weight:700; transition:color .2s; display:inline-flex; align-items:center; /*------*/
                    justify-content:center; width:26px; height:26px; } .bbgl-custom-icon:hover { color:#fff; } #bbgl-close-btn { /*-------*/
                    margin-left:12px; margin-right:16px; position:relative; top:-.5px; left:-.5px; } #bbgl-pop-btn { margin-left:0; /*----*/
                    position:relative; top:.5px; left:.5px; } #bbgl-pop-btn svg { pointer-events:bounding-box; } .bbgl-native-icon { /*---*/
                    cursor:pointer; opacity:1; transition:filter .2s; filter:drop-shadow(rgba(0,0,0,.25) 0 0 2px); } /*------------------*/
                    .bbgl-native-icon:hover { filter:brightness(1.1) drop-shadow(rgba(0,0,0,.25) 0 0 2px); } #bbgl-tooltip { /*----------*/
                    position:fixed; background-color:#464646; color:#ddd; font-family:Arial,sans-serif; font-size:12px; line-height:1.5;
                    padding:6px 8px; border-radius:5px; box-shadow:none; filter:drop-shadow(0 0 1px rgba(0,0,0,.5)); z-index:1000000; /*-*/
                    pointer-events:none; display:none; white-space:normal; height:auto; width:-moz-fit-content; width:fit-content; /*-----*/
                    max-width:280px; } #bbgl-tooltip strong { color:#fff; font-weight:700; } #bbgl-tooltip i { display:block; /*----------*/
                    margin-top:4px; color:#bbb; font-style:italic; font-size:11px; font-weight:400; } .tt-header { color:#999; /*---------*/
                    font-weight:700; border-bottom:1px solid #555; padding-bottom:4px; margin-bottom:6px; text-align:center; /*-----------*/
                    font-size:11px; letter-spacing:.5px; } .tt-energy { text-align:center; margin-bottom:6px; color:#ddd; font-size:11px;
                    font-weight:700; } .tt-row { display:flex; justify-content:space-between; align-items:center; gap:15px; font-size:11px;
                    margin-bottom:2px; } .tt-label { color:#ccc; } .tt-val { color:${CONSTANTS.COLORS.GAINS}; font-weight:700; } .tt-total { color:#fff; /*-*/
                    font-weight:700; } .tt-sub { font-size:10px; color:#999; } #bbgl-tooltip-arrow { position:absolute; width:0; height:0;
                    border:10px solid transparent; pointer-events:none; z-index:1000001; } #bbgl-tooltip.pos-top #bbgl-tooltip-arrow { /*-*/
                    border-top-color:#444; bottom:-20px; left:50%; margin-left:-10px; } #bbgl-tooltip.pos-bottom #bbgl-tooltip-arrow { /*-*/
                    border-bottom-color:#444; top:-20px; left:50%; margin-left:-10px; } #bbgl-tooltip.pos-left #bbgl-tooltip-arrow { /*---*/
                    border-left-color:#444; right:-20px; top:50%; margin-top:-10px; } #bbgl-tooltip.pos-right #bbgl-tooltip-arrow { /*----*/
                    border-right-color:#444; left:-20px; top:50%; margin-top:-10px; } #bbgl-api-hud { position:fixed; top:10px; left:10px;
                    z-index:999999; background:rgba(0,0,0,.8); color:#76ff03; padding:5px 10px; border-radius:4px; /*--------------------*/
                    font-family:'Consolas',monospace; font-size:12px; border:1px solid #333; pointer-events:none; /*----------------------*/
                    box-shadow:0 2px 5px rgba(0,0,0,.5); } #bbgl-demo-exit { background-color:#4a1070; /*--------------------------------*/
                    background-image:linear-gradient(180deg, #1a0529 0%, #6a1b9a 25%, #4a1070 60%, #4a1070 78%, #1a0529 100%); color:#fff;
                    font-family:"Fjalla One",Arial,sans-serif; font-size:10px; font-weight:400; letter-spacing:1.5px; text-align:center;
                    padding:4px 0; cursor:pointer; display:flex; align-items:center; justify-content:center; /*---------------------------*/
                    ...
                    width:auto!important; padding:0 4px; gap:4px; } #bbgl-content-wrapper { flex:1; flex-shrink:0!important; /*-----------*/
                    ...
                    background-color:#2b2b2b; box-shadow:inset 0 0 40px rgba(0,0,0,.95); border-bottom:1px solid #111; position:relative;
                    overflow:hidden; display:flex; flex-direction:column; padding-top:2px; padding-bottom:8px; /*-------------------------*/
                    transition:flex-basis .3s,margin-bottom .3s,padding-top .3s; z-index:25; } .bbgl-tall #bbgl-top-panel { flex:0 0 40%;
                    margin-bottom:-13.41%; z-index:25; box-shadow:0 5px 15px rgba(0,0,0,.5),inset 0 0 40px rgba(0,0,0,.95); /*----------*/
                    ...
                    .bbgl-expanded #bbgl-top-panel { flex:0 0 28%; } .bbgl-expanded.bbgl-tall #bbgl-top-panel { flex:0 0 38%; /*----------*/
                    ...
                    position:absolute; color:rgba(255,255,255,.55); cursor:pointer; z-index:60; user-select:none; transition:all .2s; /*-*/
                    ...
                    color:rgba(255,255,255,1); } #bbgl-tall-toggle { top:3px; left:3px; font-size:15px; font-weight:700; width:19px; /*---*/
                    height:19px; } /*-----------------------------------------------------------------------------------------------------*/
                    #bbgl-ledger-toggle, #bbgl-graph-toggle, #bbgl-achievements-toggle, #bbgl-sticker-toggle, #bbgl-copy-btn { top:5.5px;
                    width:14px; height:14px; z-index:59; opacity:0; pointer-events:none; /*-----------------------------------------------*/
                    ...
                    width:100%!important; height:100%!important; } #bbgl-top-panel::after { content:""; position:absolute; top:0; left:0;
                    ...
                    background-size:100% 100%; background-position:center; opacity:.5; pointer-events:none; mix-blend-mode:screen; /*-----*/
                    z-index:11; border-radius:inherit; } .ui-floating-label, .ui-floating-summary { position:absolute; bottom:3px; /*-----*/
                    font-size:10px; font-weight:400; pointer-events:none; z-index:50; transition:font-size .3s; } .ui-floating-label { /*-*/
                    left:8px; color:rgba(255,255,255,.4); letter-spacing:.5px; } .ui-floating-summary { right:8px; /*--------------------*/
                    ...
                    grid-template-columns:repeat(4,1fr); gap:0; transition:opacity .3s; transform-origin:center; scrollbar-width:none; }
                    ...
                    #bbgl-panel.bbgl-tall.bbgl-expanded .ledger-content { padding-top:12px; } .stat-column { display:flex; /*-------------*/
                    ...
                    .l-bot { font-size:var(--bbgl-f-bot); color:#ddd; min-height:var(--bbgl-bot-minh); height:auto; display:flex; /*------*/
                    align-items:center; justify-content:center; white-space:nowrap; transition:font-size .3s; } .c-label { font-weight:700;
                    font-family:'Arial',sans-serif; font-size:var(--bbgl-f-label); text-transform:var(--bbgl-label-case); letter-spacing:0;
                    transition:font-size .3s; } .c-gain .l-top { color:${CONSTANTS.COLORS.GAINS}; font-weight:550; } .c-gain .l-bot { color:#bbb; /*--------*/
                    font-style:normal; } .c-total .l-top { color:#fff; } .c-total .l-bot { color:#bbb; } .t-str { color:${CONSTANTS.COLORS.STR}; } .t-def {
                    ...
                    #bbgl-graph-container, #bbgl-achievements-container { display:none; flex:1; flex-direction:column; position:relative;
                    z-index:20; } .viewing-graph #bbgl-graph-container, .viewing-achievements #bbgl-achievements-container { display:flex;
                    ...
                    display:flex!important; flex-direction:column!important; flex:1!important; padding:0!important; } .g-hud { /*---------*/
                    display:flex; flex-direction:row; flex-wrap:nowrap; justify-content:space-between; align-items:center; /*-------------*/
                    margin-bottom:2px; z-index:60; position:relative; min-width:0; width:100%; box-sizing:border-box; } .g-toggles { /*---*/
                    display:flex; flex-direction:row; flex-wrap:nowrap; gap:2px; align-items:center; min-width:0; flex:0 1 auto; } /*-----*/
                    .g-pill { display:inline-flex; align-items:center; justify-content:center; font-size:8.5px; padding:.5px 5px; /*-----*/
                    ...
                    --pill-bg:rgba(220,57,18,.1); } .g-pill.p-spd { --pill-c:${CONSTANTS.COLORS.SPD}; --pill-bg:rgba(255,153,0,.1); } .g-pill.p-dex {
                    --pill-c:${CONSTANTS.COLORS.DEX}; --pill-bg:rgba(16,150,24,.1); } .g-pill.p-tot { --pill-c:${CONSTANTS.COLORS.TOT}; --pill-bg:rgba(255,255,255,.1);
                    } #bbgl-panel:not(.bbgl-expanded):not(.bbgl-mode-page) .g-hud { margin-top:1px; } /*----------------------------------*/
                    #bbgl-panel:not(.bbgl-expanded):not(.bbgl-mode-page) #bbgl-graph-container .g-pill { font-size:8px; padding:2px 5px;
                    line-height:1; display:inline-flex; align-items:center; justify-content:center; box-sizing:border-box; } /*-----------*/
                    #bbgl-graph-svg { width:100%; flex:1; min-height:0; overflow:visible; pointer-events:none; display:block; } .g-axis {
                    stroke:rgba(255,255,255,.1); stroke-width:1; } .g-path { fill:none; stroke-width:2; vector-effect:non-scaling-stroke;
                    stroke-linecap:round; transition:d .3s ease; } .g-text { fill:rgba(255,255,255,.4); font-size:9px; /*----------------*/
                    font-family:'Roboto Mono',monospace; user-select:none; } .g-text.x-label { text-anchor:middle; /*---------------------*/
                    font-family:'Fjalla One', sans-serif; font-size:11px; letter-spacing:.5px; } /*--------------------------------------*/
                    #bbgl-panel:not(.bbgl-expanded):not(.bbgl-mode-page) .g-text.x-label { font-size:10px; } .g-text.y-label { /*---------*/
                    text-anchor:end; font-family:'Barlow Condensed','Arial Narrow','Nimbus Sans Narrow',Tahoma,sans-serif; font-weight:500;
                    ...
                    background-size:cover; background-position:center; z-index:5; opacity:0; transition:opacity .3s; pointer-events:none; }
                    ...
                    justify-content:flex-start; } .sticker-nav-btn { position:absolute; top:50%; transform:translateY(-60%); width:20px;
                    height:25px; background:0 0; color:#fff; display:flex; align-items:center; justify-content:center; cursor:pointer; /*-*/
                    z-index:90; font-size:24px; font-weight:700; transition:transform .2s, text-shadow .2s; user-select:none; /*--------*/
                    line-height:1; text-shadow:0 1px 3px #000; } @media (hover: hover) { .sticker-nav-btn:hover { color:#fff; /*----------*/
                    transform:translateY(-50%) scale(1.3); text-shadow:0 0 8px rgba(255,255,255,.8); filter:none; } } /*-----------------*/
                    .sticker-nav-btn:active { color:#fff; transform:translateY(-50%) scale(1.3); text-shadow:0 0 8px rgba(255,255,255,.8);
                    filter:none; } .sticker-nav-btn.disabled { opacity:0; pointer-events:none; } #sticker-prev-btn { left:0; /*-----------*/
                    border-radius:0 5px 5px 0; } #sticker-next-btn { right:0; border-radius:5px 0 0 5px; } /*-----------------------------*/
                    .viewing-stickers #bbgl-sticker-container { display:flex; } #bbgl-sticker-grid { position:relative; display:grid; /*--*/
                    grid-template-columns:repeat(5,1fr); grid-template-rows:auto auto; width:100%; flex:1; align-content:start; /*--------*/
                    padding-top:0; row-gap:0; } .sticker-slot { display:flex; align-items:center; justify-content:center; /*--------------*/
                    position:relative; overflow:visible; padding:0; height:64px; visibility:hidden; } .sticker-slot.active-slot { /*------*/
                    visibility:visible; } #bbgl-panel.bbgl-mode-page .sticker-slot { /*---------------------------------------------------*/
                    ...
                    background:#fff; transform:scale(1.2); box-shadow:0 0 5px rgba(255,255,255,.5); } #bbgl-sticker-title { display:none;
                    position:absolute; top:7px; right:10px; font-size:12px; color:#333; font-family:'Fjalla One',sans-serif; /*-----------*/
                    letter-spacing:.2px; z-index:99; pointer-events:none; mix-blend-mode:multiply; text-align:right; } /*-----------------*/
                    .viewing-stickers #bbgl-sticker-title { display:block; } .bbgl-expanded #bbgl-sticker-title { font-size:15px; top:8px;
                    right:20px; } #bbgl-panel.bbgl-mode-page #bbgl-sticker-title { /*-----------------------------------------------------*/
                    font-size:clamp(12px,calc(12px + 8px * var(--bbgl-page-t)),20px); /*--------------------------------------------------*/
                    top:clamp(9px,calc(9px + 1px * var(--bbgl-page-t)),10px); right:clamp(8px,calc(8px + 14px * var(--bbgl-page-t)),22px);
                    } .copy-hist-btn { position:absolute; top:4px; right:5px; width:14.5px; height:14.5px; cursor:pointer; z-index:90; /*-*/
                    ...
                    #bbgl-panel.bbgl-mode-page #bbgl-graph-container .g-toggles { gap:clamp(4px,calc(4px + 2px * var(--bbgl-page-t)),6px);
                    align-items:center; } #bbgl-panel.bbgl-mode-page #bbgl-graph-container .g-text { /*-----------------------------------*/
                    ...
                    width:clamp(5px,calc(5px + 1px * var(--bbgl-page-t)),6px); height:clamp(5px,calc(5px + 1px * var(--bbgl-page-t)),6px);
                    } #bbgl-panel.bbgl-mode-page .sticker-nav-btn { font-size:clamp(24px,calc(24px + 8px * var(--bbgl-page-t)),32px); /*--*/
                    ...
                    #bbgl-item-viewer.active { display:flex; } .viewer-window { width:95%; height:100%; display:flex; align-items:center;
                    justify-content:center; position:relative; } .viewer-stage { width:100%; height:100%; position:center; /*-------------*/
                    ...
                    left:clamp(10px, 4cqi, 15px)!important; } .bbgl-expanded .vi-name { font-size:15px; } .vi-count { font-size:9px; /*---*/
                    color:#aaa; margin-bottom:2px; } #btn-close-viewer { position:absolute; top:5px; right:5px; background:0 0; /*--------*/
                    border:1px solid #555; color:#888; font-size:10px; padding:2px 6px; cursor:pointer; border-radius:3px; /*-------------*/
                    pointer-events:auto; transition:all .2s; } #btn-close-viewer:hover { border-color:#fff; color:#fff; background:#333; }
                    #bbgl-panel.bbgl-mode-page #bbgl-item-viewer { aspect-ratio:auto; } .bbgl-mode-page #bbgl-item-viewer.active { /*-----*/
                    display:flex!important; width:100%!important; height:calc(100vh - 420px + 60px * var(--bbgl-page-t))!important; /*----*/
                    min-height:clamp(300px,calc(300px + 200px * var(--bbgl-page-t)),500px)!important; border:none!important; /*-----------*/
                    ...
                    font-size:clamp(8px,calc(8px + 1px * var(--bbgl-page-t)),9px)!important; } .bbgl-mode-page #btn-close-viewer { /*-----*/
                    ...
                    height:clamp(85%,calc(85% + 7% * var(--bbgl-page-t)),92%)!important; } .bbgl-mode-page .viewer-obj { /*---------------*/
                    ...
                    display:flex; flex-direction:column; padding:0; box-sizing:border-box; overflow:hidden; will-change:transform; } /*---*/
                    .bbgl-header-wrapper { position:relative; padding:4px 0 2px 10px; margin-bottom:0; border-bottom:none; flex:0 0 85px;
                    overflow:visible; z-index:20; display:flex; flex-direction:column; justify-content:flex-end; /*-----------------------*/
                    transition:flex .3s cubic-bezier(.25,1,.5,1); } .bbgl-header-wrapper::before { content:""; position:absolute; /*----*/
                    top:4px; left:4px; right:4px; bottom:0; width:auto; height:auto; background-image:url('${ASSETS.HEADER_IMG}'); /*-----------------*/
                    background-size:100% 100%; background-position:center; opacity:1; z-index:-1; pointer-events:none; /*-----------------*/
                    ...
                    justify-content:space-between; align-items:center; padding:0 8px 0 2px; gap:8px; position:relative; margin-bottom:1px;
                    transition:margin-bottom .3s ease; } #bbgl-panel.bbgl-expanded .bbgl-month-header { margin-bottom:6px; /*-------------*/
                    gap:clamp(6px,2.08cqi,12px); } .arrow-btn { background:0 0; border:none; color:#fff; font-size:18px; cursor:pointer;
                    padding:0 5px; font-weight:700; user-select:none; line-height:1; text-shadow:0 1px 3px #000; align-self:flex-end; /*--*/
                    margin-bottom:4px; transition: transform .2s, text-shadow .2s; } @media (hover: hover) { .arrow-btn:hover { /*------*/
                    color:#fff; transform: scale(1.3); text-shadow: 0 0 8px rgba(255,255,255,.8); } } .arrow-btn:active { color:#fff; /*-*/
                    transform: scale(1.3); text-shadow: 0 0 8px rgba(255,255,255,.8); } .title-group { flex-grow:1; text-align:left; /*--*/
                    padding-left:2px; display:flex; flex-direction:row; justify-content:flex-start; align-items:center; gap:8px; } /*-----*/
                    .title-stack { display:flex; flex-direction:column; align-items:flex-start; gap:3px; } /*-----------------------------*/
                    #bbgl-panel.bbgl-expanded .title-stack { gap:6px; } #bbgl-panel.bbgl-mode-page .title-stack { /*----------------------*/
                    gap:clamp(6px,calc(6px + 4px * var(--bbgl-page-t)),10px); } .all-time-btn { width:20px; height:20px; color:#ffd700; /**/
                    cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all .2s; margin-top:4px; /*------*/
                    margin-bottom:-4px; } .all-time-btn:hover { transform:scale(1.1); filter:drop-shadow(0 0 5px rgba(255,215,0,.6)); }
                    .all-time-btn svg { width:100%; height:100%; fill:currentColor; filter:drop-shadow(0 1px 2px rgba(0,0,0,.8)); } /*---*/
                    .bbgl-expanded .all-time-btn { width:30px; height:30px; } #bbgl-panel.bbgl-mode-page .all-time-btn { /*---------------*/
                    width:clamp(28px,calc(28px + 12px * var(--bbgl-page-t)),40px); /*-----------------------------------------------------*/
                    height:clamp(28px,calc(28px + 12px * var(--bbgl-page-t)),40px); } .header-row { display:flex; align-items:center; /*--*/
                    gap:6px; position:relative; } #bbgl-panel:not(.bbgl-mode-page) .title-stack > .header-row:nth-child(2) { /*-----------*/
                    margin-bottom: -2px; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .title-stack > .header-row:nth-child(2) { /*----*/
                    margin-bottom: -4px; } .stats-btn { width:18px; height:18px; display:flex; align-items:center; justify-content:center;
                    cursor:pointer; opacity:.9; transition:all .2s; filter:drop-shadow(0 1px 2px rgba(0,0,0,.8)); } .stats-btn:hover { /**/
                    opacity:1; transform:scale(1.15); filter:drop-shadow(0 0 4px rgba(255,255,255,.6)); } .stats-btn svg { fill:#fff; /*-*/
                    width:100%; height:100%; } .header-trigger { font-family:'Fjalla One','Arial Narrow',sans-serif; font-weight:400; /*--*/
                    color:#fff; cursor:pointer; text-transform:capitalize; user-select:none; text-shadow:0 2px 4px #000; /*---------------*/
                    transition:font-size .3s; line-height:1; } .header-trigger:hover { opacity:.8; } .header-trigger::after { content:'▼';
                    font-size:8px; opacity:.5; margin-left:3px; vertical-align:middle; position:relative; top:-1px; } /*------------------*/
                    .header-trigger.disabled { cursor:default; pointer-events:none; } .header-trigger.disabled::after { display:none; } /**/
                    #year-trigger { font-size:10px; } #month-trigger { font-size:14px; } #bbgl-panel.bbgl-expanded #year-trigger { /*-----*/
                    font-size:14px; } #bbgl-panel.bbgl-expanded #month-trigger { font-size:20px; } #bbgl-panel.bbgl-expanded .stats-btn {
                    width:18px; height:18px; } #bbgl-panel.bbgl-mode-page #year-trigger { /*----------------------------------------------*/
                    font-size:clamp(14px,calc(14px + 6px * var(--bbgl-page-t)),20px); } #bbgl-panel.bbgl-mode-page #month-trigger { /*----*/
                    font-size:clamp(24px,calc(24px + 6px * var(--bbgl-page-t)),30px); } #bbgl-panel.bbgl-mode-page .stats-btn { /*--------*/
                    width:clamp(24px,calc(24px + 2px * var(--bbgl-page-t)),26px); /*------------------------------------------------------*/
                    height:clamp(24px,calc(24px + 2px * var(--bbgl-page-t)),26px); } #bbgl-panel.bbgl-mode-page .arrow-btn { /*-----------*/
                    ...
                    .bbgl-dropdown-menu { position:absolute; top:100%; left:0; background:#222; border:1px solid #444; border-radius:4px;
                    box-shadow:0 4px 15px rgba(0,0,0,.95); z-index:100; display:none; padding:4px; gap:2px; } .bbgl-dropdown-menu.show {
                    display:grid; } #bbgl-month-dropdown { grid-template-columns:repeat(3,1fr); min-width:140px; } #bbgl-year-dropdown {
                    display:none; flex:1; flex-direction:column; width:max-content; min-width:60px; } #bbgl-year-dropdown.show { /*-------*/
                    display:flex; } .drop-item { padding:8px 12px; font-size:11px; color:#999; cursor:pointer; text-align:center; /*------*/
                    border-radius:3px; } #bbgl-panel.bbgl-expanded .drop-item { font-size:13px; } .drop-item:hover { background:#333; /*--*/
                    color:#fff; } .drop-item.active { background:#ff5722; color:#fff; } .bbgl-grid-container { flex:1; display:flex; /*---*/
                    flex-direction:column; padding:0 2px; overflow:hidden; min-height:0; position:relative; z-index:1; /*-----------------*/
                    transition:padding .3s ease; } .bbgl-week-row { display:grid; grid-template-columns:repeat(7,1fr); text-align:center;
                    color:#888; font-size:10px; margin-bottom:0; font-family:'Fjalla One','Arial Narrow',sans-serif; padding-top:1px; /*--*/
                    border-top:none; flex:0 0 auto; } #bbgl-panel.bbgl-expanded .bbgl-week-row { font-size: 13px; padding-top: 5px; /*----*/
                    margin-bottom: 2px; } #bbgl-panel.bbgl-mode-page .bbgl-week-row { /*--------------------------------------------------*/
                    font-size:clamp(11px,calc(11px + 4px * var(--bbgl-page-t)),15px); /*--------------------------------------------------*/
                    ...
                    .calendar-wrapper { flex:1; display:flex; flex-direction:column; overflow-y:auto; overflow-x:hidden; position:relative;
                    -ms-overflow-style:none; scrollbar-width:none; background:#333; } .bbgl-cal-container { display:flex; /*--------------*/
                    flex-direction:column; width:100%; touch-action:pan-y; border-top:1px solid rgba(255,255,255,.05); /*----------------*/
                    border-left:1px solid rgba(255,255,255,.05); } .bbgl-row-slice { display:flex; width:100%; /*------------------------*/
                    ...
                    background:0 0; box-shadow:none; cursor:default; pointer-events:none; } .bbgl-day-cell.is-plate { z-index:2; /*-------*/
                    border-bottom:1px solid rgba(0,0,0,.4); border-right:1px solid rgba(0,0,0,.4); } /*---------------------------------*/
                    .bbgl-day-cell.ghost-cell .jewel-wrapper { opacity:.6; } .jewel-wrapper { position:absolute; top:50%; left:53%; /*----*/
                    width:80%; height:78%; transform:translate(-50%,-50%); pointer-events:none; z-index:10; /*----------------------------*/
                    filter:drop-shadow(0 3px 2px rgba(0,0,0,.5)); } .jewel-asset { width:100%; height:100%; object-fit:contain; /*-------*/
                    position:absolute; top:0; left:0; } .jewel-shine { position:absolute; inset:0; pointer-events:none; /*----------------*/
                    -webkit-mask-size:contain; mask-size:contain; -webkit-mask-repeat:no-repeat; mask-repeat:no-repeat; /*----------------*/
                    -webkit-mask-position:center; mask-position:center; } @keyframes gold-roll{ 0%{background-position:200% 0%; opacity:0}
                    15%{opacity:1} 100%{background-position:50% 0%;opacity:1} } .jewel-type-gold .jewel-asset { /*------------------------*/
                    transform:rotate(90deg) scale(1.25); } .jewel-type-gold .jewel-shine { transform: scale(1.2); filter: brightness(1.2);
                    ...
                    .jewel-type-green .jewel-asset { transform:scale(1.2); } .jewel-type-green .jewel-shine { transform:scale(1.15); /*---*/
                    ...
                    background-size:300% auto; mix-blend-mode:screen; opacity:0; } .jewel-type-green .jewel-shine-over { position:absolute;
                    z-index:3; width:100%; height:100%; transform:scale(1.2); /*----------------------------------------------------------*/
                    ...
                    mask-repeat:no-repeat; -webkit-mask-position:center; mask-position:center; } @keyframes green-flash{ 0%{ /*-----------*/
                    ...
                    z-index:20; filter:drop-shadow(-2px 4px 5px rgba(0,0,0,.4)); transform-origin: top right; /*-------------------------*/
                    ...
                    transform:translateX(0)} } @keyframes bbgl-slide-in-r{from{transform:translateX(100%)} to{transform:translateX(0)} }
                    @keyframes bbgl-slide-out-l{from{transform:translateX(0)} to{transform:translateX(-100%)} } @keyframes bbgl-slide-out-r{
                    from{transform:translateX(0)} to{transform:translateX(100%)} } .bbgl-cal-ghost{position:absolute;top:0;left:0; /*-----*/
                    ...
                    animation:green-flash-over 1.7s ease-out 1 forwards; } .bbgl-day-cell:is(.shimmer-active,.is-viewing) .sticker-shine {
                    animation:bbgl-auto-shimmer 2.4s cubic-bezier(.3, 0, .55, 1) 2 alternate forwards; opacity:1; } .day-num { /*-------*/
                    position:absolute; top:3px; left:2px; font-size:10px; width:18px; height:18px; color:#fff; font-weight:400; /*--------*/
                    font-family:'Fjalla One','Arial',sans-serif; pointer-events:none; display:flex; align-items:center; /*----------------*/
                    justify-content:center; border-radius:50%; transition:all .2s; z-index:20; } .bbgl-day-cell.ghost-cell .day-num { /*--*/
                    color:#999; } /*------------------------------------------------------------------------------------------------------*/
                    ...
                    box-shadow:inset 0 0 2px rgba(255,255,255,.2),0 1px 2px rgba(0,0,0,.8); border-top:1px solid rgba(255,255,255,.1);
                    z-index:1; } .bbgl-weekly-track.track-solidified .bbgl-seg { box-shadow:none; border-right:1px solid rgba(0,0,0,.3); }
                    .bbgl-weekly-track.track-polished { box-shadow:0 1px 3px rgba(0,0,0,.5); } .bbgl-weekly-track.track-polished::after {
                    content:""; position:absolute; top:0; bottom:0; left:0; width:100%; /*------------------------------------------------*/
                    background:linear-gradient(90deg,transparent,rgba(255,255,255,.5),transparent); opacity:.7; pointer-events:none; /*--*/
                    z-index:50; animation:bbgl-sheen-loop 7s linear infinite; } @keyframes bbgl-sheen-loop{ 0%{ /*------------------------*/
                    transform:skewX(-20deg) translateX(-150%)} 21%{transform:skewX(-20deg) translateX(250%)} 21.01%,100%{ /*--------------*/
                    transform:skewX(-20deg) translateX(-150%)} } /*-----------------------------------------------------------------------*/
                    #bbgl-panel.bbgl-no-animations .bbgl-day-cell.is-viewing :is(.jewel-type-gold .jewel-shine, .jewel-type-green .jewel-shine, .jewel-type-green .jewel-shine-over, .sticker-shine) {
                    ...
                    #bbgl-panel.bbgl-no-rates .c-gain .l-bot { min-height:0; } .bbgl-seg { height:100%; box-sizing:border-box; /*---------*/
                    position:relative; border:none; } .bbgl-seg.seg-rounded-end { border-top-right-radius:10px; /*------------------------*/
                    border-bottom-right-radius:10px; box-shadow:2px 0 3px rgba(0,0,0,.5); z-index:5; } /*--------------------------------*/
                    .seg-brushed-green, .seg-brushed-gold { box-shadow:inset 0 0 2px rgba(0,0,0,.5); /*----------------------------------*/
                    border-top:1px solid rgba(255,255,255,.1); } .seg-brushed-green { /*-------------------------------------------------*/
                    ...
                    .sticker-slot.has-item.is-scrub-hovered { z-index:45; } /*---------------------------------------------------------------*/
                    #bbgl-settings-view, #bbgl-welcome-view { background:#222; color:#ddd; display:none; /*------------------*/
                    flex-direction:column; height:100%; position:relative; overflow:hidden!important; padding:0!important; } /*-----------*/
                    ...
                    position:absolute; inset:0; background:rgba(0,0,0,.65); color:#ddd; font-family:Arial,sans-serif; font-size:12px; /*-*/
                    font-weight:700; text-align:center; display:flex; align-items:center; justify-content:center; padding:0 20px; /*------*/
                    box-sizing:border-box; z-index:50; pointer-events:all; border-radius:0 0 5px 5px; } /*--------------------------------*/
                    ...
                    background:#2a2a2a; border:1px solid #444; border-radius:5px; width:min(560px, 92vw); max-height:90vh; overflow-y:auto;
                    overflow-x:hidden; position:relative; padding:8px; box-shadow:0 10px 30px rgba(0,0,0,.6); box-sizing:border-box; /*--*/
                    -ms-overflow-style:none; scrollbar-width:none; } .bbgl-modal-window::-webkit-scrollbar { display:none; } /*-----------*/
                    .bbgl-modal-scrollbox { max-height:240px; overflow-y:auto; overflow-x:hidden; border:1px solid #1a1a1a; /*------------*/
                    background:#2a2a2a; border-radius:4px; padding:8px 10px; margin:8px 10px; font-family:Arial,sans-serif; font-size:12px;
                    color:#ccc; line-height:1.5; scrollbar-width:thin; scrollbar-color:#555 #2a2a2a; } /*---------------------------------*/
                    .bbgl-modal-scrollbox::-webkit-scrollbar { display:block; width:4px; } .bbgl-modal-scrollbox::-webkit-scrollbar-thumb {
                    background:#555; border-radius:4px; } .bbgl-modal-scrollbox strong { color:#ddd; font-size:12px; font-weight:700; } /**/
                    .bbgl-modal-scrollbox > strong { display:block; margin-top:6px; margin-bottom:2px; } /*-------------------------------*/
                    .bbgl-modal-scrollbox > strong:first-child { margin-top:0; } .bbgl-modal-scrollbox p { margin:0 0 8px 0; } /*---------*/
                    .bbgl-modal-scrollbox p:last-child { margin-bottom:0; } .bbgl-ack-row { display:flex; gap:8px; align-items:flex-start;
                    padding:4px 0; color:#ccc; } .bbgl-ack-row input[type="checkbox"] { margin-top:2px; flex:0 0 auto; cursor:pointer; }
                    .bbgl-ack-row label { cursor:pointer; flex:1; } .torn-btn.bbgl-btn-disabled { filter:grayscale(1); opacity:.5; /*-----*/
                    pointer-events:none; } .bbgl-agree-wrap { flex:1; display:block; } .bbgl-agree-wrap .torn-btn { width:100%; } /*------*/
                    @keyframes bbgl-crt-out{ 0%{transform:scale(1); opacity:1;filter:brightness(1)} 40%{transform:scale(1,.005);opacity:1;
                    filter:brightness(3)} 100%{transform:scale(0,0);opacity:0;filter:brightness(0)} } @keyframes bbgl-crt-in{ 0%{ /*------*/
                    transform:scale(0,0); opacity:0;filter:brightness(0)} 60%{transform:scale(1,.005);opacity:1;filter:brightness(3)} 100%{
                    transform:scale(1);opacity:1;filter:brightness(1)} } .bbgl-crt-out { animation:bbgl-crt-out .3s ease-in forwards; /*--*/
                    transform-origin:center; pointer-events:none; } .bbgl-crt-in { animation:bbgl-crt-in .3s ease-out forwards; /*--------*/
                    transform-origin:center; } [data-tooltip] { cursor:default; } .bbgl-day-cell.ghost-cell::after { content:""; /*-------*/
                    display:block; } .bbgl-day-cell.is-archived .day-num { text-shadow:0 1px 4px rgba(0,0,0,1),0 0 2px rgba(0,0,0,1); /*--*/
                    z-index:20; } @media (max-width: 800px) { .bbgl-paste-icon { display: none !important; } .bbgl-native-input { /*------*/
                    ...
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container .g-pill { font-size:9.5px!important; /*----------*/
                    padding:.5px 5px!important; line-height:1.18!important; } /*---------------------------------------------------------*/
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container .g-toggles { gap:4px!important; /*---------------*/
                    align-items:center!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container .g-hud { /*------*/
                    margin-bottom:2px!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container .g-text { /*------*/
                    font-size:9px!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container .g-text.x-label { /*--*/
                    font-size:9px!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .stats-btn { width:28px!important; /*-------*/
                    ...
                    width:16px!important; height:16px!important; } } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .bbgl-header-wrapper {
                    flex:0 0 clamp(122px,calc(122px + 23px * var(--bbgl-dock-t,0)),145px)!important; } /*---------------------------------*/
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .bbgl-header-wrapper::before { left:0!important; right:0!important; /*-*/
                    top:0!important; border-radius:5px 5px 0 0!important; } #bbgl-panel:not(.bbgl-mode-page) { /*-------------------------*/
                    ...
                    --bbgl-f-top-mb:clamp(3px,calc(3px + 3px * (1 - var(--bbgl-dock-t,0))),6px); } /*-------------------------------------*/
                    #bbgl-panel:not(.bbgl-mode-page) #bbgl-bottom-panel { overflow-y:auto!important; overflow-x:hidden!important; /*------*/
                    scrollbar-width:none; -ms-overflow-style:none; } #bbgl-panel:not(.bbgl-mode-page) .bbgl-grid-container { /*-----------*/
                    padding:0!important; overflow:visible!important; height:auto!important; flex:none!important; } /*---------------------*/
                    #bbgl-panel:not(.bbgl-mode-page) .calendar-wrapper { overflow:visible!important; height:auto!important; /*------------*/
                    flex:none!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .bbgl-month-header { padding-left:8px!important;
                    padding-right:clamp(10px,2.78cqi,16px)!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .day-num { /*------*/
                    font-size:clamp(11px,2.78cqi,16px)!important; top:clamp(3px,1.04cqi,6px)!important; /*--------------------------------*/
                    left:clamp(3px,1.04cqi,6px)!important; width:clamp(20px,5.2cqi,30px)!important; /*------------------------------------*/
                    height:clamp(20px,5.2cqi,30px)!important; } /*------------------------------------------------------------------------*/
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .bbgl-day-cell.is-viewing .day-num { /*--------------------------------*/
                    font-size:clamp(15px,3.82cqi,22px)!important; width:clamp(24px,6.25cqi,36px)!important; /*----------------------------*/
                    ...
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #year-trigger { font-size:clamp(14px,2.78cqi,16px)!important; } /*-----*/
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #month-trigger { font-size:clamp(20px,3.99cqi,23px)!important; } /*----*/
                    ...
                    #bbgl-panel:not(.bbgl-expanded):not(.bbgl-mode-page) .ui-floating-label, #bbgl-panel:not(.bbgl-expanded):not(.bbgl-mode-page) .ui-floating-summary {
                    font-size:10.5px!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .stats-btn { width:28px!important; /*----*/
                    height:28px!important; } /*-------------------------------------------------------------------------------------------*/
                    ...
                    /* narrow panels dip below old 9.8px floor --------*/ padding:clamp(.5px,calc(.35px + .16cqi),1.5px) clamp(5px,1.39cqi,8px)!important;
                    line-height:1!important; display:inline-flex!important; align-items:center!important; justify-content:center!important;
                    box-sizing:border-box!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container .g-toggles {
                    ...
                    font-size:clamp(10px,1.91cqi,11px)!important; } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-graph-container {
                    ...
                    --bbgl-ach-scroll-pt:clamp(1px,.48cqi,8px); --bbgl-ach-scroll-pb:clamp(0px,.06cqi,2px); /*--------------------------*/
                    --bbgl-ach-footer-pt:clamp(0px,.06cqi,1px); --bbgl-ach-footer-pb:2px; /*---------------------------------------------*/
                    padding-top:var(--bbgl-ach-container-pt)!important; padding-left:var(--bbgl-ach-inset-x)!important; /*----------------*/
                    ...
                    --bbgl-ach-inset-x:clamp(4px,1vw,12px); } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .sticker-slot { /*-----------*/
                    height:min(clamp(95px,calc(80px + 2.6cqi),95px), clamp(95px,calc(80px + 2.4cqb),95px))!important; } /*----------------*/
                    ...
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-sticker-grid { column-gap:clamp(1px,calc(.8cqi),5px)!important;
                    row-gap:clamp(0px,calc(.4cqi),3px)!important; align-content:center!important; } /*-----------------------------------*/
                    ...
                    .bbgl-coming-soon { position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); color:rgba(255,255,255,.7);
                    font-size:24px; font-weight:bold; letter-spacing:2px; z-index:10; pointer-events:none; /*-----------------------------*/
                    text-shadow:0 0 10px rgba(255,255,255,.2); text-align:center; line-height:1.2; } @keyframes bbgl-gold-glow-once { 0% {
                    text-shadow:0 0 0 rgba(255,215,0,0), 0 1px 3px rgba(0,0,0,.85); } 100% { /*------------------------------------------*/
                    ...
                    width:100%; flex:1; align-content:center; align-items:center; justify-items:center; padding:0; gap:0; margin:0 -6px;
                    } #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) #bbgl-sponsor-grid { gap:0!important; padding:0!important; /*------*/
                    margin:0 -10px!important; } #bbgl-panel.bbgl-mode-page #bbgl-sponsor-grid { gap:0; padding:0; /*----------------------*/
                    ...
                    .bbgl-expanded .sponsor-sticker-label { font-size:11px; } #bbgl-panel.bbgl-mode-page .sponsor-sticker-label { /*------*/
                    font-size:clamp(8px,calc(8px + 5px * var(--bbgl-page-t)),13px); } .pg-dot.pg-dot-sponsor.active { /*------------------*/
                    background:linear-gradient(135deg,#b8860b,#ffd700,#fffacd,#ffd700,#b8860b)!important; /*------------------------------*/
                    box-shadow:0 0 6px rgba(255,215,0,.85)!important; transform:scale(1.3); } .bbgl-ach-scroll { display:flex; /*--------*/
                    flex-direction:column; flex:1 1 auto; min-height:0; overflow:hidden; overflow-x:hidden; /*----------------------------*/
                    padding:var(--bbgl-ach-scroll-pt) var(--bbgl-ach-inset-x) var(--bbgl-ach-scroll-pb); -ms-overflow-style:none; /*------*/
                    scrollbar-width:none; box-sizing:border-box; } .bbgl-ach-scroll::-webkit-scrollbar { display:none; } /*---------------*/
                    #bbgl-achievements-container { position:relative; min-height:0; overflow:hidden; container-type:inline-size; /*-------*/
                    container-name:bbgl-ach-root; --bbgl-ach-font:'Barlow Condensed','Arial Narrow','Nimbus Sans Narrow',Tahoma,sans-serif;
                    ...
                    --bbgl-ach-nav-fs:clamp(7px,calc(1.45 * var(--bbgl-ach-dot-w)),11px); --bbgl-ach-nav-py:0; /*-----------------------*/
                    --bbgl-ach-nav-px:clamp(2px,.55cqi,10px); } #bbgl-ach-pages { container-type:inline-size; container-name:bbgl-ach; /**/
                    width:100%; box-sizing:border-box; flex:1; min-height:0; overflow:hidden; } #bbgl-ach-footer, .bbgl-ach-footer { /*---*/
                    ...
                    padding:var(--bbgl-ach-nav-py) var(--bbgl-ach-nav-px); margin:0; transition:color .2s; font-family:'Arial',sans-serif;
                    display:inline-flex; align-items:center; justify-content:center; background:transparent; border:none; line-height:1;
                    -webkit-appearance:none; appearance:none; } body:not(.is-touch-device) .bbgl-ach-nav:hover { color:#fff; /*-----------*/
                    text-shadow:0 0 3px #fff; } .bbgl-ach-section { margin-bottom:0; width:100%; box-sizing:border-box; } /*--------------*/
                    ...
                    font-family:var(--bbgl-ach-font); font-size:clamp(10px,2cqi,12px); font-weight:700; letter-spacing:.08em; /*----------*/
                    ...
                    color:#bbb; font-family:var(--bbgl-ach-font); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; width:100%;
                    } .ach-v-wrap { display:flex; align-items:flex-end; gap:3px; flex-shrink:0; justify-content:flex-end; } .ach-sub { /*-*/
                    font-size:clamp(7.5px,1.55cqi,9px); font-weight:600; color:#222; letter-spacing:.3px; /*------------------------------*/
                    ...
                    font-variant-numeric:tabular-nums; display:inline-flex; align-items:center; justify-content:flex-end; flex-wrap:nowrap;
                    gap:4px; } .bbgl-ach-row .ach-value .view-std,.bbgl-ach-row .ach-value .view-exp { font-weight:550; } /*--------------*/
                    ...
                    font-size:clamp(9px,1.88cqi,10px); font-weight:500; color:#999; font-family:var(--bbgl-ach-font); text-align:left; /*-*/
                    margin-left:6px; line-height:1; letter-spacing:.01em; } /*------------------------------------------------------------*/
                    #bbgl-panel.bbgl-expanded .ach-date, #bbgl-panel.bbgl-mode-page .ach-date { display:block; } .ach-fx-green { /*-------*/
                    ...
                    -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent; /*---------------------------*/
                    animation:bbgl-ach-shimmer 4s linear 1; } @keyframes bbgl-ach-shimmer { 0% { background-position:200% 0; } 100% { /*--*/
                    background-position:0 0; } } @keyframes bbgl-ach-glow-gold { 0% { /*--------------------------------------------------*/
                    text-shadow:0 0 0 rgba(255,215,0,0), 0 1px 2px rgba(0,0,0,.8); } 100% { /*-------------------------------------------*/
                    ...
                    gap:var(--bbgl-ach-dot-gap); padding:0; flex-shrink:0; } #bbgl-ach-pageindicator .pg-dot { width:var(--bbgl-ach-dot-w);
                    height:var(--bbgl-ach-dot-w); } #bbgl-ach-pageindicator .pg-dot.active { transform:scale(1.2); /*---------------------*/
