...
export { _syncChannel, _xtabSyncTimer, syncWithFeedback, scheduleHeartbeat, startBackgroundSync, checkExitSync, GYM_STAT_LOGS, syncSidebarState, getTopCeiling, _getLayoutWindows, _syncLayoutResizeTargets, syncChangelogNotif, syncSiblingSelect };
